...
import { TextBold, TextUnderline, TextItalic, ArrowForward, Back, TextalignJustifycenter, Edit2, BrushBig } from 'iconsax-react';
    ...
    return (
        <>
            <Box className={classes.header}>
                ...
                />
                <TextUnderline size="20" onClick={() => handleFontStyle('underline')}
                 style={{
                 ...
                 />
                <TextItalic size="20" onClick={() => handleFontStyle('italic')} 
                style={{
