...
export default function RightDrawer({ state, toggleDrawer }) {
               ...
               {!state ? <Box onClick={toggleDrawer} sx={{ cursor: 'pointer', position: 'relative',right:'1rem',height: 'fit-content' }}>
                ...
                <Box sx={{ display: state ? 'block' : 'none', width: state ? 'inherit' : '0px' , marginTop:'2rem', overflow:'auto'}}>
                    <>
                        ...
                        >
                            <AccordionSummary sx={{
                                '& .MuiAccordionSummary-content':{ margin:'0px'}}} expandIcon={<ExpandMoreIcon />} aria-controls="panel1bh-content" id="panel1bh-header">
                        ...
                        >
                            <AccordionSummary sx={{margin:'0px'}}  expandIcon={<ExpandMoreIcon />} aria-controls="panel2bh-content" id="panel2bh-header">
